...
<html>
   <head>
      <title>flake8 violations: env\Lib\site-packages\django\contrib\gis\db\backends\mysql\introspection.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="env.Lib.site-packages.django.contrib.gis.db.backends.mysql.introspection.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="env.Lib.site-packages.django.contrib.gis.db.backends.mysql.introspection.source.html#l23">
                  <tt><i>23</i>                     <span class="c1"># Using OGRGeomType to convert from OGC name to Django field.</span></tt>
               </a>
            </li>
            </ul>
         </li>

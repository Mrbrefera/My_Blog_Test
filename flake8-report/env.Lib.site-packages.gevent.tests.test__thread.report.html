...
<html>
   <head>
      <title>flake8 violations: env\Lib\site-packages\gevent\tests\test__thread.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="env.Lib.site-packages.gevent.tests.test__thread.source.html">
               <img src="file.svg" alt="&#x2261;">
            </a></p>
         <h1>
            <a href="index.html">
               <img src="back.svg" alt="&#x2B05;">
               env\Lib\site-packages\gevent\tests\test__thread.py
            </a>
         </h1>
         ...
         <li>
            ...
            <li>
               ...
               <a href="env.Lib.site-packages.gevent.tests.test__thread.source.html#l10">
                  <tt><i>10</i> <span class="k">except</span> <span class="ne">ImportError</span><span class="p">:</span> <span class="c1"># Py2</span></tt>
               </a>
            </li>
            </ul>
         </li>

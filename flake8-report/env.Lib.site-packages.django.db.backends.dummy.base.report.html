...
<html>
   <head>
      <title>flake8 violations: env\Lib\site-packages\django\db\backends\dummy\base.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="env.Lib.site-packages.django.db.backends.dummy.base.source.html">
               <img src="file.svg" alt="&#x2261;">
            </a></p>
         <h1>
            <a href="index.html">
               <img src="back.svg" alt="&#x2B05;">
               env\Lib\site-packages\django\db\backends\dummy\base.py
            </a>
         </h1>
         ...
         <li>
            ...
            <li>
               ...
               <a href="env.Lib.site-packages.django.db.backends.dummy.base.source.html#l4">
                  <tt><i>4</i> <span class="sd">Django uses this if the database ENGINE setting is empty (None or empty string).</span></tt>
               </a>
            </li>
            </ul>
         </li>

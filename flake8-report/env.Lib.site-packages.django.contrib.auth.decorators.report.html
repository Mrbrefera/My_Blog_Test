...
<html>
   <head>
      <title>flake8 violations: env\Lib\site-packages\django\contrib\auth\decorators.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="env.Lib.site-packages.django.contrib.auth.decorators.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="env.Lib.site-packages.django.contrib.auth.decorators.source.html#l10">
               ...
               <a href="env.Lib.site-packages.django.contrib.auth.decorators.source.html#l38">
                  <tt><i>38</i> <span class="k">def</span> <span class="nf">login_required</span><span class="p">(</span><span class="n">function</span><span class="o">=</span><span class="kc">None</span><span class="p">,</span> <span class="n">redirect_field_name</span><span class="o">=</span><span class="n">REDIRECT_FIELD_NAME</span><span class="p">,</span> <span class="n">login_url</span><span class="o">=</span><span class="kc">None</span><span class="p">):</span></tt>
               </a>
            </li>
            </ul>
         </li>

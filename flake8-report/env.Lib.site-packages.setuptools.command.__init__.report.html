...
<html>
   <head>
      <title>flake8 violations: env\Lib\site-packages\setuptools\command\__init__.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="env.Lib.site-packages.setuptools.command.__init__.source.html">
         ...
         <li>
            ...
            <li>
               ...
               <a href="env.Lib.site-packages.setuptools.command.__init__.source.html#l3">
                  <tt><i>3</i> <span class="c1"># Can&#39;t disable on the exact line because distutils doesn&#39;t exists on Python 3.12</span></tt>
               </a>
            </li>
            </ul>
         </li>

...
<html>
   <head>
      <title>flake8 violations: env\Lib\site-packages\setuptools\logging.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="env.Lib.site-packages.setuptools.logging.source.html">
               <img src="file.svg" alt="&#x2261;">
            </a></p>
         <h1>
            <a href="index.html">
               <img src="back.svg" alt="&#x2B05;">
               env\Lib\site-packages\setuptools\logging.py
            </a>
         </h1>
         ...
         <li>
            ...
            <li>
               ...
               <a href="env.Lib.site-packages.setuptools.logging.source.html#l31">
                  <tt><i>31</i>         <span class="c1"># For some reason `distutils.log` module is getting cached in `distutils.dist`</span></tt>
               </a>
            </li>
            </ul>
         </li>

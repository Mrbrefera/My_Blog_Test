...
<html>
   <head>
      <title>flake8 violations: env\Lib\site-packages\django\dispatch\__init__.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="env.Lib.site-packages.django.dispatch.__init__.source.html">
               <img src="file.svg" alt="&#x2261;">
            </a></p>
         <h1>
            <a href="index.html">
               <img src="back.svg" alt="&#x2B05;">
               env\Lib\site-packages\django\dispatch\__init__.py
            </a>
         </h1>
         ...
         <li>
            ...
            <li>
               ...
               <a href="env.Lib.site-packages.django.dispatch.__init__.source.html#l3">
                  <tt><i>3</i> <span class="sd">Originally based on pydispatch (BSD) https://pypi.org/project/PyDispatcher/2.0.1/</span></tt>
               </a>
            </li>
            </ul>
         </li>

...
<html>
   <head>
      <title>flake8 violations: env\Lib\site-packages\PIL\_tkinter_finder.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="env.Lib.site-packages.PIL._tkinter_finder.source.html">
               <img src="file.svg" alt="&#x2261;">
            </a></p>
         <h1>
            <a href="index.html">
               <img src="back.svg" alt="&#x2B05;">
               env\Lib\site-packages\PIL\_tkinter_finder.py
            </a>
         </h1>
         ...
         <li>
            ...
            <li>
               ...
               <a href="env.Lib.site-packages.PIL._tkinter_finder.source.html#l18">
                  <tt><i>18</i>     <span class="c1"># not available. load_tkinter_funcs will check the binary first in any case.</span></tt>
               </a>
            </li>
            </ul>
         </li>

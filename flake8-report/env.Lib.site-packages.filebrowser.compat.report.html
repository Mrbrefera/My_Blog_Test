...
<html>
   <head>
      <title>flake8 violations: env\Lib\site-packages\filebrowser\compat.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="env.Lib.site-packages.filebrowser.compat.source.html">
               <img src="file.svg" alt="&#x2261;">
            </a></p>
         <h1>
            <a href="index.html">
               <img src="back.svg" alt="&#x2B05;">
               env\Lib\site-packages\filebrowser\compat.py
            </a>
         </h1>
         ...
         <li>
            ...
            <li>
               ...
               <a href="env.Lib.site-packages.filebrowser.compat.source.html#l7">
                  <tt><i>7</i>     </tt>
               </a>
            </li>
            </ul>

...
<html>
   <head>
      <title>flake8 violations: env\Lib\site-packages\pip\_vendor\rich\color_triplet.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="env.Lib.site-packages.pip._vendor.rich.color_triplet.source.html">
               <img src="file.svg" alt="&#x2261;">
            </a></p>
         <h1>
            <a href="index.html">
               <img src="back.svg" alt="&#x2B05;">
               env\Lib\site-packages\pip\_vendor\rich\color_triplet.py
            </a>
         </h1>
         ...
         <li>
            ...
            <li>
               ...
               <a href="env.Lib.site-packages.pip._vendor.rich.color_triplet.source.html#l35">
                  <tt><i>35</i> <span class="sd">            Tuple[float, float, float]: A tuple of three normalized colour components.</span></tt>
               </a>
            </li>
            </ul>
         </li>

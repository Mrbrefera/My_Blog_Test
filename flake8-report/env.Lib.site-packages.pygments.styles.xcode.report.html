...
<html>
   <head>
      <title>flake8 violations: env\Lib\site-packages\pygments\styles\xcode.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="env.Lib.site-packages.pygments.styles.xcode.source.html">
               <img src="file.svg" alt="&#x2261;">
            </a></p>
         <h1>
            <a href="index.html">
               <img src="back.svg" alt="&#x2B05;">
               env\Lib\site-packages\pygments\styles\xcode.py
            </a>
         </h1>
         ...
         <li>
            ...
            <li>
               ...
               <a href="env.Lib.site-packages.pygments.styles.xcode.source.html#l47">
                  <tt><i>47</i>         <span class="c1"># Workaround for a BUG here: lexer treats multiline method signatres as labels</span></tt>
               </a>
            </li>
            </ul>
         </li>
         ...
         <li>
            ...
            <li>
               ...
               <a href="env.Lib.site-packages.pygments.styles.xcode.source.html#l25">
                  <tt><i>25</i>     </tt>
               </a>
            </li>
            </ul>

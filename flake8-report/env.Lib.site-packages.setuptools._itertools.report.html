...
<html>
   <head>
      <title>flake8 violations: env\Lib\site-packages\setuptools\_itertools.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="env.Lib.site-packages.setuptools._itertools.source.html">
               <img src="file.svg" alt="&#x2261;">
            </a></p>
         <h1>
            <a href="index.html">
               <img src="back.svg" alt="&#x2B05;">
               env\Lib\site-packages\setuptools\_itertools.py
            </a>
         </h1>
         ...
         <li>
            ...
            <li>
               ...
               <a href="env.Lib.site-packages.setuptools._itertools.source.html#l7">
                  <tt><i>7</i> <span class="sd">    Wrap an iterable to raise a ValueError if non-unique values are encountered.</span></tt>
               </a>
            </li>
            </ul>
         </li>

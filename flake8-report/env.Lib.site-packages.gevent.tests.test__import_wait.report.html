...
<html>
   <head>
      <title>flake8 violations: env\Lib\site-packages\gevent\tests\test__import_wait.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="env.Lib.site-packages.gevent.tests.test__import_wait.source.html">
               <img src="file.svg" alt="&#x2261;">
            </a></p>
         <h1>
            <a href="index.html">
               <img src="back.svg" alt="&#x2B05;">
               env\Lib\site-packages\gevent\tests\test__import_wait.py
            </a>
         </h1>
         ...
         <li>
            ...
            <li>
               ...
               <a href="env.Lib.site-packages.gevent.tests.test__import_wait.source.html#l6">
                  <tt><i>6</i>     <span class="kn">import</span> <span class="nn">_import_wait</span> <span class="c1"># pylint:disable=import-error</span></tt>
               </a>
            </li>
            </ul>
         </li>

...
<html>
   <head>
      <title>flake8 violations: env\Lib\site-packages\pyflakes\reporter.py</title>
      ...
      <div id="page">
         <p id="srclink">
            <a title="View full annotated source"
               href="env.Lib.site-packages.pyflakes.reporter.source.html">
               <img src="file.svg" alt="&#x2261;">
            </a></p>
         <h1>
            <a href="index.html">
               <img src="back.svg" alt="&#x2B05;">
               env\Lib\site-packages\pyflakes\reporter.py
            </a>
         </h1>
         ...
         <li>
            ...
            <li>
               ...
               <a href="env.Lib.site-packages.pyflakes.reporter.source.html#l64">
                  <tt><i>64</i>             <span class="c1"># some versions of python emit an offset of -1 for certain encoding errors</span></tt>
               </a>
            </li>
            </ul>
         </li>
